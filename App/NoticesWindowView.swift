...
/// Scrollable view of third-party open-source licence notices, rendered as HTML.
struct NoticesWindowView: View {
    @State private var html = ""

    var body: some View {
        NoticesWebView(html: self.html)
...
private struct NoticesWebView: NSViewRepresentable {
    let html: String
