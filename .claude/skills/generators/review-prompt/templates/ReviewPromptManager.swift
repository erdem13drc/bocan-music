...
final class ReviewPromptManager {
    ...
    func shouldRequestReview() -> Bool {
        ...
        guard self.isAppStoreVersion() else { return false }

        return self.conditions.isSatisfied(
    ...
    private func requestReview() {
        #if os(iOS)
            self.requestReviewiOS()
        #elseif os(macOS)
            self.requestReviewmacOS()
        #endif
    }
    ...
    var debugStats: String {
        ...
        Should prompt: \(self.shouldRequestReview())
        """
    }
}
