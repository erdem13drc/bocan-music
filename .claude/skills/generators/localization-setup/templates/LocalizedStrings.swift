...
enum L10n {
    ...
    enum Settings {
        ...
        static let appearance = String(
            localized: "settings.appearance",
            defaultValue: "Appearance"
        )
        static let notifications = String(
            localized: "settings.notifications",
    ...
    enum Error {
        static let genericTitle = String(
            localized: "error.generic.title",
            defaultValue: "Error"
        )
        static let genericMessage = String(
            localized: "error.generic.message",
            defaultValue: "Something went wrong. Please try again."
        )
        static let networkTitle = String(
            localized: "error.network.title",
            defaultValue: "Network Error"
        )
        static let networkMessage = String(
            localized: "error.network.message",
            defaultValue: "Please check your internet connection."
        )
        static let saveFailed = String(
            localized: "error.save_failed",
            defaultValue: "Failed to save. Please try again."
        )
        static let loadFailed = String(
            localized: "error.load_failed",
        ...
        static func custom(_ message: String) -> String {
            String(
                localized: "error.custom \(message)",
    ...
    static func daysRemaining(_ count: Int) -> String {
        String(
            localized: "days.remaining \(count)",
    ...
    static func lastUpdated(_ date: Date) -> String {
        String(
            localized: "last_updated \(date, format: .dateTime)",
    ...
    enum Accessibility {
        static let closeButton = String(
            localized: "accessibility.close_button",
            defaultValue: "Close"
        )
        static let backButton = String(
            localized: "accessibility.back_button",
            defaultValue: "Go back"
        )
        static let menuButton = String(
            localized: "accessibility.menu_button",
            defaultValue: "Open menu"
        )
        static let favoriteButton = String(
            localized: "accessibility.favorite_button",
            defaultValue: "Add to favorites"
        )
        static let shareButton = String(
            localized: "accessibility.share_button",
            defaultValue: "Share"
        )
